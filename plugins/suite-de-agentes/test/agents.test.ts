...
describe("agent materialization", () => {
  it("materializes agent-task-manager cleanly to global path with mode all", () => {
    ...
    expect(content).toContain("list: allow");
    ...
    expect(content).toContain("external_directory: ask");
    expect(content).toContain("bash:\n");
    expect(content).toContain("\"git status*\": allow");
    expect(content).toContain("\"git branch --show-current*\": allow");
    expect(content).toContain("\"git log*\": allow");
    expect(content).toContain("\"git rev-parse*\": allow");
    expect(content).toContain("\"*\": ask");
    expect(content).toContain("edit:\n");
    expect(content).toContain("\"*Task-Manager-Portable.html*\": allow");
    expect(content).toContain("\"*drop-in-task-manager.html*\": allow");
