...
Selecting any model, including re-selecting the same model, MUST immediately trigger the effort selector. Unsupported models MUST show only `Predeterminado` and continue cleanly.
